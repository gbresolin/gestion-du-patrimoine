    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <div class="mt-3">
                    <span class="font-weight-bold">KHALDI</span> -
                    <span class="font-weight-bold">ESTIVAL</span> -
                    <span class="font-weight-bold">BRESOLIN</span> -
                    <span class="font-weight-bold">MAGNIN</span>
                </div>
            </div>
        </div>
    </body>
